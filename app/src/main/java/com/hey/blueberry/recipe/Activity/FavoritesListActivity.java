...
public class FavoritesListActivity extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        item[2]=new Recipe_item(R.drawable.c,"마늘향이 폴폴 나는 촉촉한 프렌치토스트", "요리재료 우유1/2컵, 계란 1개,통식빵 1/2개식용유 1큰술, 버터 1큰술, 다진마늘 1큰술, 설탕 1큰술 - -", "15분 이내", "초보", "http://t1.daumcdn.net/thumb/C115x85/?fname=http%3A%2F%2Fm1.daumcdn.net%2Fcfile163%2Fattach%2F992C28415A8CE08301DC9D", "read?articleId=77386&bbsId=MC001&pageIndex=1", true);
        ...
        item[4]=new Recipe_item(R.drawable.e,"[오소리감투 볶음] 오소리감투 볶음 만드는 법", "요리재료 오소리감투 외 - 돼지부속물 , 레시피 , 만드는법 , 만들기 , 반찬 , 볶음 , 오소리감투 , 오소리감투볶음 , 요리", "15분 이내", "보통", "http://t1.daumcdn.net/thumb/C115x85/?fname=http%3A%2F%2Fm1.daumcdn.net%2Fcfile163%2Fattach%2F99BFA6365A8CB04B2F4C0E", "read?articleId=77384&bbsId=MC001&pageIndex=1", true);
